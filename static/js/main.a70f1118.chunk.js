...
var httpLink=Object(client["createHttpLink"])({uri:"https://f05645eb7161.ngrok.io/graphql"});var hasSubscriptionOperation=function hasSubscriptionOperation(_ref){var definitions=_ref.query.definitions;return definitions.some(function(_ref2){var kind=_ref2.kind,operation=_ref2.operation;return kind==='OperationDefinition'&&operation==='subscription';});};var authLink=Object(context["a" /* setContext */])(function(obj,_ref3){var headers=_ref3.headers;var token=localStorage.getItem('token');return{headers:Object(objectSpread2["a" /* default */])({},headers,{authorization:token?"Bearer ".concat(token):''})};});var httpAuthLink=authLink.concat(httpLink);// TODO: Send the token dynamically
var src_token=localStorage.getItem('token');var cable=action_cable_default.a.createConsumer("wss://f05645eb7161.ngrok.io/cable");var cableAuthLink=authLink.concat(new dist["ActionCableLink"]({cable:cable,connectionParams:{token:src_token}}));var src_link=client["ApolloLink"].split(hasSubscriptionOperation,cableAuthLink,httpAuthLink);// Initialize the client
...
//# sourceMappingURL=main.a70f1118.chunk.js.map